...
interface BookmarkServiceAsync {
    ...
    fun list(): CompletableFuture<BookmarkListPageAsync> = list(BookmarkListParams.none())
    ...
    fun list(
        params: BookmarkListParams = BookmarkListParams.none()
    ): CompletableFuture<BookmarkListPageAsync> = list(params, RequestOptions.none())

    /** @see list */
    fun list(requestOptions: RequestOptions): CompletableFuture<BookmarkListPageAsync> =
    ...
    interface WithRawResponse {
         ...
         */
        fun list(): CompletableFuture<HttpResponseFor<BookmarkListPageAsync>> =
