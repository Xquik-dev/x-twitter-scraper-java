...
interface TweetService {
    ...
    /** Look up tweet */
    fun retrieve(tweetId: String): TweetRetrieveResponse =
    ...
    fun retrieve(
        tweetId: String,
        params: TweetRetrieveParams = TweetRetrieveParams.none(),
    ): TweetRetrieveResponse = retrieve(tweetId, params, RequestOptions.none())
    ...
    /** Delete tweet */
    fun delete(tweetId: String, params: TweetDeleteParams): TweetDeleteResponse =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun retrieve(tweetId: String): HttpResponseFor<TweetRetrieveResponse> =
            retrieve(tweetId, TweetRetrieveParams.none())
        ...
        fun retrieve(
            tweetId: String,
            params: TweetRetrieveParams = TweetRetrieveParams.none(),
        ): HttpResponseFor<TweetRetrieveResponse> = retrieve(tweetId, params, RequestOptions.none())
        ...
        fun delete(
            tweetId: String,
            params: TweetDeleteParams,
        ): HttpResponseFor<TweetDeleteResponse> = delete(tweetId, params, RequestOptions.none())
