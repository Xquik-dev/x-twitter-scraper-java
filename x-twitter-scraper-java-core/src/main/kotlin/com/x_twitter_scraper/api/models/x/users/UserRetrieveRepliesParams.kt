...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): UserRetrieveRepliesParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.includeParentTweet] with `includeParentTweet.orElse(null)`.
         */
        fun includeParentTweet(includeParentTweet: Optional<Boolean>) =
            includeParentTweet(includeParentTweet.getOrNull())
