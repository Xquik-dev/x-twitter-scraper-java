...
private constructor(
    ...
    fun range(): Optional<String> = Optional.ofNullable(range)
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.range] with `range.orElse(null)`. */
        fun range(range: Optional<String>) = range(range.getOrNull())
