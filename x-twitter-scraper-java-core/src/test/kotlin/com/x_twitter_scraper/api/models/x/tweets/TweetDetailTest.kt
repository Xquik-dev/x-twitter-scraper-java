...
internal class TweetDetailTest {
    ...
    fun create() {
        ...
        assertThat(tweetDetail.isTranslatable()).contains(true)
        ...
        assertThat(tweetDetail.possiblySensitive()).contains(true)
        ...
        assertThat(tweetDetail.viewState()).contains("viewState")
    }
