...
internal class EventDetailTest {
    ...
    fun create() {
        ...
        assertThat(eventDetail.keywordMonitorId()).contains("21")
        assertThat(eventDetail.query()).contains("xquik OR \"x api\"")
        assertThat(eventDetail.username()).contains("elonmusk")
