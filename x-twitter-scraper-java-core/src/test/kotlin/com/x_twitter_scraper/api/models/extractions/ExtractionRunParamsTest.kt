...
internal class ExtractionRunParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.collectionStrategy()).contains(ExtractionRunParams.CollectionStrategy.AUTO)
        assertThat(body.conversationId()).contains("1234567890")
        assertThat(body.dedupeAcrossTargets()).contains(true)
        assertThat(body.dedupeMode()).contains(ExtractionRunParams.DedupeMode.NONE)
        ...
        assertThat(body.queryType()).contains(ExtractionRunParams.QueryType.LATEST)
        ...
        assertThat(body.scope()).contains(ExtractionRunParams.Scope.ALL)
        ...
        assertThat(body.sort()).contains(ExtractionRunParams.Sort.RELEVANCE)
        ...
        assertThat(body.targets().getOrNull())
            .containsExactly(ExtractionRunParams.Target.ofString("string"))
