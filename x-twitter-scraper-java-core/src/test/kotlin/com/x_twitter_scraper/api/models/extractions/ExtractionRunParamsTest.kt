...
internal class ExtractionRunParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.mediaType()).contains(ExtractionRunParams.MediaType.IMAGES)
        ...
        assertThat(body.quotes()).contains(ExtractionRunParams.Quotes.INCLUDE)
        assertThat(body.quotesOfTweetId()).contains("1234567890")
        assertThat(body.replies()).contains(ExtractionRunParams.Replies.INCLUDE)
        assertThat(body.resultsLimit()).contains(1000L)
        assertThat(body.retweets()).contains(ExtractionRunParams.Retweets.EXCLUDE)
