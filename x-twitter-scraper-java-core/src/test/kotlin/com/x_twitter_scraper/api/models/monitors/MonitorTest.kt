...
internal class MonitorTest {
    ...
    fun create() {
        ...
        assertThat(monitor.pausedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(monitor.pausedReason()).contains(Monitor.PausedReason.X_USER_NOT_FOUND)
    }
