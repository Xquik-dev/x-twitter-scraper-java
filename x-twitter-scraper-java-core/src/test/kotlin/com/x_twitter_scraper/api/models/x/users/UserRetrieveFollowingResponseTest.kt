...
internal class UserRetrieveFollowingResponseTest {
    ...
    fun ofPaginatedUsers() {
        ...
        assertThat(userRetrieveFollowingResponse.paginatedUsers()).contains(paginatedUsers)
        assertThat(userRetrieveFollowingResponse.listCoverage()).isEmpty
    }
    ...
    fun ofListCoverage() {
        ...
        assertThat(userRetrieveFollowingResponse.paginatedUsers()).isEmpty
        assertThat(userRetrieveFollowingResponse.listCoverage()).contains(listCoverage)
    }
