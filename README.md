...
[![Maven Central](https://img.shields.io/maven-central/v/com.xquik.api/x-twitter-scraper-java)](https://central.sonatype.com/artifact/com.xquik.api/x-twitter-scraper-java/0.6.0)
[![Javadocs](https://javadoc.io/badge2/com.xquik.api/x-twitter-scraper-java/0.6.0/javadoc.svg)](https://javadoc.io/doc/com.xquik.api/x-twitter-scraper-java/0.6.0)
...
```kotlin
implementation("com.xquik.api:x-twitter-scraper-java:0.6.0")
```
